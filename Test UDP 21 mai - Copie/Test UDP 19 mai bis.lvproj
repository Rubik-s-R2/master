...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="RandomizeIRL.vi" Type="VI" URL="../RandomizeIRL.vi"/>
		<Item Name="RecupCommand.vi" Type="VI" URL="../RecupCommand.vi"/>
		<Item Name="ReversedSolution.vi" Type="VI" URL="../ReversedSolution.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Décomposition tableau String 1D.vi" Type="VI" URL="../Camera/Décomposition tableau String 1D.vi"/>
			...
			<Item Name="reconnaissance couleur (SubVI).vi" Type="VI" URL="../Camera/reconnaissance couleur (SubVI).vi"/>
			<Item Name="Reconstitution face (SubVI).vi" Type="VI" URL="../Camera/Reconstitution face (SubVI).vi"/>
			<Item Name="Rubik&apos;s Solver.dll" Type="Document" URL="../../Projet final 1.1/Rubik&apos;s Solver.dll"/>
			<Item Name="String to first letter lowercase(SubVI).vi" Type="VI" URL="../Camera/String to first letter lowercase(SubVI).vi"/>
			<Item Name="tab init.vi" Type="VI" URL="../Camera/tab init.vi"/>
			<Item Name="traitement cam 03.vi" Type="VI" URL="../Camera/traitement cam 03.vi"/>
			<Item Name="traitement cam 33.vi" Type="VI" URL="../Camera/traitement cam 33.vi"/>
			<Item Name="traitement cam 37.vi" Type="VI" URL="../Camera/traitement cam 37.vi"/>
			<Item Name="traitement cam A1.vi" Type="VI" URL="../Camera/traitement cam A1.vi"/>
			<Item Name="Verification.vi" Type="VI" URL="../Camera/Verification.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
	<Item Name="NI-myRIO-1900-031fe113" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-031fe113</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="InitJuju.vi" Type="VI" URL="../InitJuju.vi"/>
		<Item Name="MotorMoveIRL.vi" Type="VI" URL="../MotorMoveIRL.vi"/>
